...
- **架構=「PP 完整成品鏡像＋本地政策層」**:PP 的核心、外掛、`index.html`、`sw.js`、`assets/`、`public/` 都整包同步;本站只以冪等補丁保留舊傭兵獎勵／招募／受僱政策、回城免費更新快照、離線安全、妖精傭兵技能例外與全裝置隱藏來源橫幅。
...
| `afk-merc-policy.js` | 舊傭兵獎勵／招募／受僱政策、回城免費更新快照與妖精傭兵不限當前屬性精靈魔法 |
